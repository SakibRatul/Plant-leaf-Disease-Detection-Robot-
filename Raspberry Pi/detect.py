...
def run(model: str, max_results: int, score_threshold: float, 
  ...
  while cap.isOpened():
    ...
    # send image to server without waiting for result
    loop = asyncio.get_event_loop()
    loop.run_until_complete(send_image_to_server())
    if not success:
      sys.exit(
